          ...
          <div className="col-span-2 md:col-span-1">
            <Link to="/buildunion" className="inline-block mb-4">
              <span className="text-2xl font-display font-light tracking-tight">
                ...
                <span className="text-amber-600">Union</span>
              </span>
            </Link>
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-9 h-9 rounded-full bg-slate-200 hover:bg-amber-500 hover:text-white text-slate-600 flex items-center justify-center transition-colors duration-200"
                >
