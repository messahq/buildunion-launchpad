...
interface GeneralMessaChatProps {
  open: boolean;
  onClose: () => void;
}
...
export function GeneralMessaChat({ open, onClose }: GeneralMessaChatProps) {
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-border/50 bg-gradient-to-r from-amber-500/10 to-orange-500/10">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-muted-foreground">Platform & Construction AI</p>
            </div>
          </div>
            ...
            <div className="text-center py-8 space-y-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  BuildUnion platform help, construction codes & best practices.
                </p>
              </div>
        ...
        <div className="p-3 border-t border-border/50 bg-background/80">
          <div className="flex items-end gap-2">
            <textarea
              ...
              placeholder="Ask about BuildUnion or construction..."
              rows={1}
