...
// ✓ REFACTORED: Types, constants, and helpers extracted to definition-flow/types.ts
import {
  type TemplateItem,
  type TeamMember,
  type UploadedFile,
...
const VisualUploadCanvasPanel = ({
  ...
  return (
    <div className="h-full w-full flex flex-col overflow-hidden relative bg-gradient-to-br from-gray-100 via-gray-200 to-gray-100 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
      ...
      {/* Main content - flex layout, no scroll on container */}
      <div className="flex-1 flex flex-col min-h-0 p-3 gap-3 relative z-10">
        
        {/* Drag & Drop Upload Zone - always visible */}
        <motion.div
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          className="shrink-0"
