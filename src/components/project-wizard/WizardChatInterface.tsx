              ...
              >
                <div
                  className={cn(
                    ...
                    message.type === 'user'
                      ? "bg-amber-50/90 dark:bg-amber-950/30 border border-amber-500/40 text-gray-800 dark:text-gray-100 rounded-br-md shadow-lg shadow-amber-900/10"
                      : "bg-white/90 dark:bg-[#111827]/80 border border-amber-400/25 dark:border-amber-500/15 text-gray-700 dark:text-gray-300 rounded-bl-md shadow-md",
